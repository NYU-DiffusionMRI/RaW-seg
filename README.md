...
The code implements random walker (RaW) segmentations of myelinated axons in 3d electron microscopy (EM) data, developed in [Lee, et al., Brain Struc Func, 2019](https://doi.org/10.1007/s00429-019-01844-6). All functions are implemented in MATLAB and defined in 3 classes:
...
* **Random walker (RaW) segmentation, quantification of orientation and diameter of axons**
  - [Lee, et al., Brain Struc Func, 2019](https://doi.org/10.1007/s00429-019-01844-6)
